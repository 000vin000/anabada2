...
<body>
    <div class="container">
        ...
        <!-- 수정 폼 -->
        <form action="${pageContext.request.contextPath}/question/edit/${question.questionNo}" method="post">
            ...
            <div class="form-group">
                ...
                <a href="${pageContext.request.contextPath}/question/myQuestions" class="btn btn-secondary">취소</a>
            </div>
        </form>
    </div>
</body>
