...
<div class="body-container">
	...
	<section class="user-info">
	    <h3>사용자 정보</h3>
	    <a class="update-info" id="updateInfoBtn" href="#">회원정보 수정</a>
	    <a class="update-info" id="updatePwBtn" href="#">비밀번호 변경</a> 
	    <a class="update-info" id="updatePinBtn" href="#">2차 비밀번호 변경</a>
	    <a class="update-info" id="withdrawBtn" href="#">회원 탈퇴</a>
	</section>
