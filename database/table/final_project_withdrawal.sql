...
CREATE TABLE `withdrawal` (
  `withdrawal_no` int NOT NULL AUTO_INCREMENT,
  `withdrawal_created_date` datetime(6) DEFAULT NULL,
  `withdrawal_email` varchar(255) DEFAULT NULL,
  `withdrawal_reason` varchar(255) DEFAULT NULL,
  `withdrawal_type` varchar(255) DEFAULT NULL,
  `withdrawal_user_no` int NOT NULL,
  PRIMARY KEY (`withdrawal_no`),
  KEY `FKnafvbcy1657fawbkdcikdnvrm` (`withdrawal_user_no`),
  CONSTRAINT `FKnafvbcy1657fawbkdcikdnvrm` FOREIGN KEY (`withdrawal_user_no`) REFERENCES `user` (`user_no`)
...
INSERT INTO `withdrawal` VALUES (1,'2025-03-27 00:00:00.000000','asdf0320@test.com','test','VOLUNTARY',1);
